...
void loop() {
  ...
  // Call the function to turn the car 90 degrees to the right
  turnRight90Degrees();
...
// It sets a specific speed and duration for the turn.
// After the turn, it stops the motors.
void turnRight90Degrees() {
  int speed = 150; // Set speed to 150
  int duration = 400; // Set duration to 400 milliseconds

  car.turnRight(speed, duration); // Turn right at 150 speed for 400 milliseconds
  delay(duration); // Wait for the duration of the turn

  car.stopMotors(); // Stop the car after turning
}